...
SVec3f Raycast(const SVec3f& Origin, const SVec3f& Direction, const std::vector<SSphere>& Spheres, const std::vector<SLight>& LightSources, const int& MaxRecursion = 0);
...
SVec3f Refract(const SVec3f& Ray, const SVec3f& Normal, const float& RefractiveIndex);
